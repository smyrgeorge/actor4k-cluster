...
mavenPublishing {
    ...
    pom {
        ...
        scm {
            url = "https://github.com/smyrgeorge/actor4k-cluster"
            connection = "scm:git:https://github.com/smyrgeorge/actor4k-cluster.git"
            developerConnection = "scm:git:git@github.com:smyrgeorge/actor4k-cluster.git"
        }
    }
